...
public final class App {
    ...
    public static void main(String... args) throws ReadException {
        ...
        // Weather task
        List<WeatherRawView> weatherData = csvReader.readFile("src/main/resources/de/bcxp/challenge/weather.csv", WeatherRawView.class);
        ...
        List<CountryRawView> countryData = csvReader.readFile("src/main/resources/de/bcxp/challenge/countries.csv", CountryRawView.class);
